...
const ProjectsSection: React.FunctionComponent<ProjectsSectionProps> = (
  ...
  return (
    <>
      ...
      >
        <TypingEffect staticText="as a" text={['Software Engineer', 'Data Engineer']} />
      </Box>
